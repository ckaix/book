...
```
import "github.com/labstack/echo"复制代码
```
...
```
github.com/labstack/echo，复制代码
```

那么执行命令

```
go install github.com/labstack/echo复制代码
```
...
```
package semaphore // import "golang.org/x/sync/semaphore"复制代码
```
...
```
go get golang.org/x/sync/semaphore复制代码
```
