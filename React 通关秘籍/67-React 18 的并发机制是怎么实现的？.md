...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/855a154a837148baa23081088756151b~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1080&h=287&s=62356&e=png&b=ffffff)

vdom 是指 React Element 的对象树：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/38736547cc364112ae0bf3f57f4d89e3~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=958&h=552&s=244700&e=png&b=1e1d1d)

之后这个 vdom 会转换为 fiber 结构：

![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5229ddf0916944909be3f214a97258e1~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1304&h=740&s=253239&e=png&b=fefdfd)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bb1d08c9fb8c4a879f96344a6f9b22a8~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1514&h=394&s=32955&e=png&b=ffffff)

循环处理每个 fiber 节点的时候，有个指针记录着当前的 fiber 节点，叫做 workInProgress。

这个循环叫做 workLoop：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c54edf29da2a45f48b8aa5eb3647074e~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=740&h=292&s=46880&e=png&b=1e1e1e)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ff1a03c562b54904899dc9a8f5bfa0ed~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1910&h=430&s=188416&e=png&b=ffffff)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/479cc2b24bdf46daac214f36d2ef87a3~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1040&h=292&s=59287&e=png&b=1f1f1f)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3c3cd7ab2eea4a0aaa2786b9b9e79efb~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=672&h=470&s=50435&e=png&b=1f1f1f)

然后把剩下的节点 schdule 就好了。当再次 schedule 到这个任务，就会继续渲染。

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/53a00058a09e4cf38011849cf8a880c5~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1330&h=542&s=133771&e=png&b=1e1e1e)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/aa3f280365d34fa59db5e518efffbab2~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1034&h=522&s=90361&e=png&b=1e1e1e)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/173203d93b37453687bfbd3dd1501b9b~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1038&h=560&s=93143&e=png&b=1f1f1f)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/52aaa6b45216469f8d9ecaece41786a5~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=622&h=232&s=39917&e=png&b=1e1e1e)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/50f98a9d8e75477cbe2ce2fa9fee0ab0~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1664&h=918&s=312117&e=png&b=1f1f1f)

这样设计的好处，自然是可以用二进制运算快速得到是哪种优先级了：

比如按位与、按位或等：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2e9d1876d65841bf96fbe2a8ec75378e~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1412&h=90&s=38828&e=png&b=1e1e1e)

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5de14084a57f42878527304af920508d~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=786&h=116&s=28045&e=png&b=1e1e1e)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d9ea7750892c4d5f9ea5c98cf37dd90d~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1664&h=918&s=283389&e=png&b=1e1e1e)

是不是就很像赛道：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/44824c2544314587af70c7f4ad32c122~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1226&h=438&s=1207255&e=png&b=806644)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/621f03ae0002482eb9e38fdd92a9aa7d~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=922&h=686&s=116021&e=png&b=1e1e1e)

怎么实现的 Lane 优先级转 Event 优先级，那就是有几个分界点了：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0198956afad44c4ca5085c2079c8c43b~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1160&h=1134&s=187332&e=png&b=1e1e1e)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/09e6d7be54a44fbe9a2d0dba8d590558~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=844&h=476&s=60353&e=png&b=1e1e1e)

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0e8481731912482dbbf550a69c4b013c~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=740&h=292&s=47602&e=png&b=1f1f1f)

并发执行：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e23e8cf738534822b207dc1b26f3bfa6~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=896&h=422&s=60603&e=png&b=1f1f1f)

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c3fa46a8b1614243a0776a22c6dee16c~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1040&h=292&s=58951&e=png&b=1f1f1f)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/87c53e1253644ebebfc161b0363e3ff0~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=2006&h=164&s=66332&e=png&b=1e1e1e)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b057d5bd19ea4b529080cb0951f2d3af~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1708&h=796&s=198698&e=png&b=1e1e1e)

源码里是在调用回调函数之前设置了更新的优先级为 ContinuousEvent 的优先级，也就是连续事件优先级，比 DiscreteEvent 离散事件优先级更低，所以会比另一个 setState 触发的渲染的优先级低，在调度的时候排在后面。

这里设置的其实就是 Lane 的优先级：

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2c0b607b3dee4c38b595a2244bbd83f4~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=938&h=266&s=61661&e=png&b=1e1e1e)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b9ff71ed92e74b00a5199a629d5b6e47~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.image#?w=1152&h=728&s=131741&e=png&b=1e1e1e)
